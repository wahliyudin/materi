                        ...
                        <div data-kt-search-element="wrapper">
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <span class="symbol-label bg-light">
                                                ...
                                                <span class="svg-icon svg-icon-2 svg-icon-primary"><svg width="18"
                            ...
                            <div data-kt-search-element="empty" class="text-center d-none">
                                ...
                                <div class="pt-10 pb-10">
                                    ...
                                    <span class="svg-icon svg-icon-4x opacity-50"><svg width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.3"
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-6">
                                <a href="apps/projects/budget.html"
                                    ...
                                    <span class="svg-icon svg-icon-3x svg-icon-primary mb-2"><svg width="24"
                                            height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.3"
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="symbol symbol-35px me-4">
                                                <span class="symbol-label bg-light-warning">
                                                    <!--begin::Svg Icon | path: icons/duotune/finance/fin006.svg-->
                                                    <span class="svg-icon svg-icon-2 svg-icon-warning"><svg
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path opacity="0.3"
                                                                d="M20 15H4C2.9 15 2 14.1 2 13V7C2 6.4 2.4 6 3 6H21C21.6 6 22 6.4 22 7V13C22 14.1 21.1 15 20 15ZM13 12H11C10.5 12 10 12.4 10 13V16C10 16.5 10.4 17 11 17H13C13.6 17 14 16.6 14 16V13C14 12.4 13.6 12 13 12Z"
